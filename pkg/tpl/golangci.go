...
// GolangCITemplate define a golangci lint template
func GolangCITemplate() []byte {
	return []byte(`## Golden config for golangci-lint v1.48.0
#
...
issues:
  ...
  exclude-rules:
    - source: "^//\\s*go:generate\\s"
      linters: [ lll ]
    - source: "(BasePath|noinspection|TODO)"
      linters: [ godot ]
    - source: "//noinspection"
      linters: [ gocritic ]
